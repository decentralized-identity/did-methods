...
| **Consider categories defined by DID Rubric: <https://www.w3.org/TR/did-rubric/>** | A DID Rubric Evaluation by the `did:webvh` specification editors can be found on the [`did:webvh` Information Site](https://didwebvh.info/latest/did-rubric-evaluation/) |
